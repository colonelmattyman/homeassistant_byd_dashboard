...
> **Important:** The sensor entity names in the `state:` lines (e.g. `sensor.<font color="red">byd_sealion_7_battery_level` ) are generated by the BYD Vehicle integration based on the name you gave your vehicle during setup. If your vehicle was named differently, these entity IDs will differ. Check Settings → Devices & Services → BYD Vehicle to confirm your entity names and adjust accordingly. <img width="697" height="223" alt="image" src="https://github.com/user-attachments/assets/2bfdd495-9fa0-4d06-86d9-11ab458903ff" />
